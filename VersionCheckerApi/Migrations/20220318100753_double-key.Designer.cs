...
namespace VersionCheckerApi.Migrations
{
    ...
    [Migration("20220318100753_double-key")]
    partial class doublekey
    {
            ...
            modelBuilder.Entity("ModulePackage", b =>
                {
                    ...
                    b.HasKey("ModulesModuleId", "PackagesName", "PackagesVersion");

                    b.HasIndex("PackagesName", "PackagesVersion");
            ...
            modelBuilder.Entity("ModulePackage", b =>
                {
                    ...
                    b.HasOne("VersionCheckerApi.Persistence.Package", null)
                        .WithMany()
                        .HasForeignKey("PackagesName", "PackagesVersion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
